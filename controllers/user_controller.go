...
func CreateUser() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		//Validate required fields using the validator libs
...
func EditUser() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		//use the validator lib to validate required fields
		...
		Name, Location, Title := user.Name, user.Location, user.Title
